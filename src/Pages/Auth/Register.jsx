    ...
    <div className='' >
        ...
        <div className='grid gap-3 md:grid-cols-2 max-w-[1000px] overflow-y-auto mx-auto items-center bg-opacity-0 p-2 pt-0 rounded-lg'>
            <div className='font-new md:text-3xl px-5'>
                <ReactTyped strings={[`"Don't want to travel alone? Our website matches you with a compatible travel partner who shares your itinerary. Say goodbye to lonely trips and hello to new friendships and unforgettable experiences."`]} typeSpeed={40} />
            </div>
            <div className='border-blue-300 0border-2 0shadow-lg shadow-main p-2 rounded-lg my-2'>
                <h1 className='text-xl text-center my-2 text-main'>Register</h1>
                <RegisterForm/>
            </div>
        </div>
    </div>
